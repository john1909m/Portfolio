...
export const Portfolio = () => {
  ...
  return (
    <>
        <div className="portfolio-head m-10 mx-14   w-[70%] ">
            ...
            <div className="portfolio-category mt-5 w-[70%] ">
                <ul className='flex w-full justify-between align-text-bottom'>
                    <li className='hover:cursor-pointer underline hover:bg-orange-500 hover:font-bold font-semibold p-3 transition-all rounded-lg' onClick={()=> setSelectedCategory('web')}>Web Design</li>
                    <li className='hover:cursor-pointer underline hover:bg-orange-500 hover:font-bold font-semibold p-3 transition-all rounded-lg' onClick={()=> setSelectedCategory('graphic')}>Graphic Design</li>
                </ul>
            </div>
        </div>
